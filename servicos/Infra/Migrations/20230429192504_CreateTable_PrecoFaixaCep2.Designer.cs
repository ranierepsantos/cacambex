...
namespace Infra.Migrations
{
    ...
    [Migration("20230429192504_CreateTable_PrecoFaixaCep2")]
    partial class CreateTable_PrecoFaixaCep2
    {
            ...
            modelBuilder.Entity("Domain.TipoCacambas.Agregacao.PrecoFaixaCep", b =>
                {
                    ...
                    b.Property<int>("TipoCacambaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TipoCacambaId");

                    b.ToTable("PrecoFaixaCeps");
                });

            modelBuilder.Entity("Domain.TipoCacambas.Agregacao.TipoCacamba", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
